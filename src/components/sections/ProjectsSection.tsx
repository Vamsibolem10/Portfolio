...
const ProjectModal = ({ project, onClose }: { project: Project; onClose: () => void }) => (
  ...
  >
    <motion.div
      ...
      className="bg-white/95 backdrop-blur-xl border border-zinc-200 shadow-2xl rounded-2xl w-full max-w-2xl p-8"
    >
      <div className="mb-6 flex items-start justify-between">
        <div>
          ...
          <p className="mt-4 border-l-[3px] border-zinc-200 pl-4 font-heading text-sm font-bold uppercase tracking-widest text-zinc-500">
            {project.subtitle}
          </p>
        </div>
      ...
      <div className="flex gap-3">
        {project.demoLink && (
          <a href={project.demoLink} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded border border-primary bg-primary/10 px-6 py-2.5 font-heading text-sm font-semibold tracking-wider text-primary transition-all hover:bg-primary hover:text-primary-foreground hover:shadow-[0_0_20px_hsl(142_70%_45%/0.3)]">
